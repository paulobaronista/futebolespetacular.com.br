...
<div class="container-fluid padding-off bg-ei">
    <div class="container">
        <div class="row">
...
<div class="container-fluid padding-off bg-contato">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <p class="txt-01">
...
<div id="aviso" class="aviso text-center">
    <div>
        ...
        <p>O e-mail não pode ser enviado!<br />
            ...
            Se o problema persistir, entre em contato pelo e-mail <strong>contato@futebolespetacular.com.br</strong></p>
    </div>
</div>